...
const OfertasEnviadas = () => {
  ...
  useEffect(() => {
    if (user.tipo !== 'comprador') {
      // Redirecionar se não for comprador
  ...
  const carregarOfertas = async () => {
    try {
      setLoading(true);
      const response = await ofertaService.listarEnviadas({
      ...
      console.error('Erro ao carregar ofertas enviadas:', error);
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="flex h-screen bg-gray-100">
      ...
      <div className="flex-1 overflow-auto">
        <div className="p-6">
          <h1 className="text-2xl font-bold text-gray-800 mb-6">Ofertas Enviadas</h1>
            ...
            <>
              <div className="mb-4">
                <p className="text-gray-600">
                  Exibindo {ofertas.length} de {paginacao.total} ofertas enviadas
                </p>
              </div>
              ...
              {ofertas.length > 0 ? (
                          ...
                          <tr key={oferta._id} className="hover:bg-gray-50">
                            ...
                            <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                              ...
                              {oferta.status === 'pendente' && (
                                <Link
                                  to={`/ofertas/${oferta._id}/cancelar`}
                ...
                <div className="bg-white rounded-lg shadow p-6 text-center">
                  ...
                  <p className="text-gray-500 mb-4">
                    Você ainda não enviou nenhuma oferta ou os filtros aplicados não retornaram resultados.
                  </p>
                  <Link
                    to="/marketplace"
